    ...
    <div class="col-8 text-center">
            <div class="card mb-6 shadow-sm text-center">
                ...
                <form  method="POST" action="{{ route('me.store') }}" enctype="multipart/form-data">
                    ...
                    <hr>
                    <div class="form-group">
                        <label for="category-title"><h4 name="category-title">Seleccione una categoria</h4></label>
                    ...
                    <div class="form-group">
                        <textarea name="description" class="form-control" cols="80" rows="5" placeholder="Descripcion de la app.." style=" resize: none;"></textarea>
                    </div>
                    <div>
                    ...
                    <hr>
                    <div class="form-group">
                        <label for="image"><h4 name="image">Cargar imagen de la app</h4></label><br>
