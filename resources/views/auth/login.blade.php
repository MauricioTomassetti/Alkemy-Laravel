        ...
        <div class="form_container">
            ...
            <div class="row clearfix justify-content-center">
                <form method="POST" action="{{ route('login') }}" onsubmit="localStorage.clear();">
                    @csrf
                    <div class="input_field"> <span><svg width="1.2em" height="1.2em" viewBox="0 0 16 16" class="bi bi-envelope mt-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <input class="button" type="submit" value="Acceso" />
                </form>
            </div>
        </div>
    </div>
